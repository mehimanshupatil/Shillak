...
import {
  MonthlyRecapPrototypeSection,
  RecapPrototypeSwitcher,
  // PROTOTYPE — wayfinder ticket #9, drop this import + mount when resolved
} from './MonthlyRecap.prototype'
...
export default function Dashboard() {
  ...
  const showRecapPrototype = searchParams.has('recap')
  ...
  return (
    <div className="flex flex-col gap-0 pb-24">
      ...
      {/* PROTOTYPE — wayfinder ticket #9, ?recap=a|b|c */}
      {showRecapPrototype && <MonthlyRecapPrototypeSection />}
      ...
      <QuickAddFAB />
      {showRecapPrototype && <RecapPrototypeSwitcher />}
